...
config :sahajyog, SahajyogWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "DpAhSXUGfTsQWU1wAwzkCKnDzg57DxbxhChWJN4LeAA5WQnzitYI7N/lNIvzDoc4",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:sahajyog, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:sahajyog, ~w(--watch)]}
  ]
...
config :sahajyog, SahajyogWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/sahajyog_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :sahajyog, dev_routes: true
