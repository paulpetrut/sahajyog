defmodule SahajyogWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    case opts[:count] do
      count when is_integer(count) ->
        Gettext.dngettext(SahajyogWeb.Gettext, "errors", msg, msg, count, opts)

      _ ->
        Gettext.dgettext(SahajyogWeb.Gettext, "errors", msg, opts)
    end
  end
