defmodule SahajyogWeb.DemoLive2 do
  ...
  def render(assigns) do
    ~H"""
    <div id="demo2-page" phx-hook="WelcomeAnimations" class="overflow-x-hidden">
      <%!-- Scroll Progress Bar --%>
      ...
      <div class="min-h-screen bg-gradient-to-br from-base-300 via-base-200 to-base-300 animate-gradient mesh-gradient noise-overlay overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pt-3 sm:pt-4 lg:pt-4 pb-6 sm:pb-8 relative z-10">
          ...
          <section id="hero-section" class="text-center mb-3 sm:mb-4 lg:mb-3 2xl:mb-[3vh]">
            <h1 class="text-2xl sm:text-3xl lg:text-4xl 2xl:text-[3.5rem] font-bold text-base-content mb-2 sm:mb-2 2xl:mb-4 animate-hero-fade-up title-elegant tracking-wide">
              {gettext("Welcome to Sahaja Yoga")}
            </h1>
            <p class="text-base sm:text-lg lg:text-xl 2xl:text-[1.5rem] text-base-content/70 mb-3 sm:mb-4 2xl:mb-[3vh] animate-hero-fade-up-delay-1">
              {gettext("Discover inner peace through meditation")}
            </p>

            <%!-- Daily update banner --%>
            <div class={[
              "flex items-center justify-center px-4 animate-hero-fade-up-delay-2 transition-all duration-300",
            ...
            <div class="max-w-3xl lg:max-w-2xl xl:max-w-3xl mx-auto">
              ...
              <div class="glass-card rounded-2xl 2xl:rounded-3xl overflow-hidden">
                ...
                <div class="p-4 sm:p-5 2xl:p-6">
                  <h2 class="text-base sm:text-lg 2xl:text-xl font-bold text-base-content break-words">
                    {@current_video.title}
                  </h2>
                </div>
              </div>
          ...
          <section class="py-16 sm:py-20 scroll-reveal">
            <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-base-content text-center mb-10 sm:mb-12">
            ...
            <div class="grid md:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <.card class="p-6 sm:p-8">
                  <p class="text-base-content/90 leading-relaxed mb-5 text-base sm:text-lg">
                    {gettext(
                  ...
                  <p class="text-base-content/90 leading-relaxed text-base sm:text-lg">
                    {gettext(
          ...
          <section class="py-16 sm:py-20 scroll-reveal bg-base-200/40 -mx-3 sm:-mx-6 lg:-mx-8 px-3 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
              <h3 class="text-xl sm:text-2xl lg:text-3xl font-bold text-base-content text-center mb-10 sm:mb-12">
          ...
          <section class="py-16 sm:py-20 lg:hidden scroll-reveal">
            <h2 class="text-xl sm:text-2xl font-bold text-base-content text-center mb-8 sm:mb-10">
            ...
            <div class="quote-card relative bg-gradient-to-br from-base-200 to-base-300 rounded-3xl p-8 sm:p-10 text-center max-w-lg mx-auto border border-base-content/5 shadow-xl overflow-hidden">
              ...
              <div class="relative z-10">
                ...
                <blockquote class="text-xl sm:text-2xl text-base-content/90 leading-[1.3] mb-6 font-serif italic">
                  "{gettext(
          ...
          <section class="py-16 sm:py-20 hidden lg:block scroll-reveal">
            <h2 class="text-3xl lg:text-4xl font-bold text-base-content text-center mb-12">
              {gettext("Quotes from Shri Mataji")}
            </h2>
                  ...
                  <div class="carousel-slide min-w-full flex-shrink-0">
                    <div class="quote-card relative bg-gradient-to-br from-base-200 to-base-300 rounded-3xl p-10 lg:p-12 text-center border border-base-content/5 shadow-xl overflow-hidden">
                      ...
                      <div class="relative z-10">
                        ...
                        <blockquote class="text-2xl lg:text-3xl xl:text-4xl text-base-content/90 leading-[1.3] max-w-3xl mx-auto mb-8 font-serif italic">
                          "{gettext(
                            "Sahaja Yoga is a very subtle happening within us. It's a very subtle happening. And this subtler happening gives you sensitivity to divine joy."
                          )}"
                        </blockquote>
          ...
          <section class="py-16 sm:py-20 scroll-reveal bg-base-200/40 -mx-3 sm:-mx-6 lg:-mx-8 px-3 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
              <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-base-content text-center mb-4">
                {gettext("What Practitioners Say")}
              </h2>
              <p class="text-base-content/70 text-center mb-12 max-w-2xl mx-auto text-lg">
              ...
              <div class="grid md:grid-cols-3 gap-6 lg:gap-8">
                <%= for {testimonial, idx} <- Enum.with_index(@testimonials) do %>
                  <div class="testimonial-card bg-gradient-to-br from-base-100 to-base-200 rounded-2xl p-6 sm:p-8 border border-base-content/5 shadow-lg">
          ...
          <section id="stats-section" class="py-16 sm:py-20 scroll-reveal">
          ...
          <section
            id="how-it-works"
            class="py-16 sm:py-20 scroll-reveal bg-base-200/40 -mx-3 sm:-mx-6 lg:-mx-8 px-3 sm:px-6 lg:px-8"
          >
            <div class="max-w-7xl mx-auto">
              <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-base-content text-center mb-4">
              ...
              <div class="grid md:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div class="relative step-card">
                  <div class="text-center p-6 sm:p-8 rounded-2xl hover:bg-base-100/50 transition-colors">
                    ...
                    <h3 class="text-xl sm:text-2xl font-bold text-base-content mb-4">
                      {gettext("Learn")}
                    </h3>
                    <p class="text-base-content/80 text-base sm:text-lg leading-relaxed">
          ...
          <%!-- Call to Action --%>
          <section class="py-16 sm:py-20 scroll-reveal-scale">
            <%= if @current_scope do %>
