    ...
    <Layouts.app flash={@flash} current_scope={assigns[:current_scope]}>
      <style>
        ...
        .candy-cane-border {
          ...
          background:
            linear-gradient(#1a3a1a, #1a3a1a) padding-box,
      ...
      >
        ...
        <div class="fixed top-0 left-0 right-0 z-50 flex justify-center gap-4 py-2 pointer-events-none">
          <span class="twinkle text-2xl" style="animation-delay: 0s;">💡</span>
          <span class="twinkle text-2xl" style="animation-delay: 0.2s; color: var(--christmas-red);">💡</span>
          <span class="twinkle text-2xl" style="animation-delay: 0.4s; color: var(--christmas-green);">💡</span>
          <span class="twinkle text-2xl" style="animation-delay: 0.6s; color: var(--christmas-gold);">💡</span>
          <span class="twinkle text-2xl" style="animation-delay: 0.8s;">💡</span>
          <span class="twinkle text-2xl" style="animation-delay: 1s; color: var(--christmas-red);">💡</span>
          <span class="twinkle text-2xl" style="animation-delay: 1.2s; color: var(--christmas-green);">💡</span>
          <span class="twinkle text-2xl" style="animation-delay: 1.4s; color: var(--christmas-gold);">💡</span>
          <span class="twinkle text-2xl" style="animation-delay: 1.6s;">💡</span>
          <span class="twinkle text-2xl hidden sm:inline" style="animation-delay: 1.8s; color: var(--christmas-red);">💡</span>
          <span class="twinkle text-2xl hidden sm:inline" style="animation-delay: 2s; color: var(--christmas-green);">💡</span>
          <span class="twinkle text-2xl hidden md:inline" style="animation-delay: 2.2s; color: var(--christmas-gold);">💡</span>
          <span class="twinkle text-2xl hidden md:inline" style="animation-delay: 2.4s;">💡</span>
          <span class="twinkle text-2xl hidden lg:inline" style="animation-delay: 2.6s; color: var(--christmas-red);">💡</span>
          <span class="twinkle text-2xl hidden lg:inline" style="animation-delay: 2.8s; color: var(--christmas-green);">💡</span>
        </div>
          ...
          <div class="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8">
            <div class="hero-reveal">
              ...
              <div class="relative">
                ...
                <span class="absolute -right-8 bottom-0 text-3xl ornament-swing hidden md:inline" style="animation-delay: -1s;">⭐</span>
              </div>
              ...
              <div class="grid grid-cols-3 gap-1 md:gap-4 lg:gap-8 mt-6 md:mt-16 lg:mt-20">
                ...
                <.link navigate={~p"/steps"} class="step-card group cursor-pointer">
                  <div class="text-center p-2 md:p-6 rounded-xl hover:bg-white/5 transition-colors">
                    <div class="relative w-12 h-12 md:w-20 md:h-20 mx-auto mb-2 md:mb-4 rounded-full bg-gradient-to-br from-green-600 to-green-800 flex items-center justify-center shadow-lg shadow-green-500/30 ornament-swing" style="animation-delay: -1s;">
                ...
                >
                  <div class="text-center p-2 md:p-6 rounded-xl hover:bg-white/5 transition-colors">
                    <div class="relative w-12 h-12 md:w-20 md:h-20 mx-auto mb-2 md:mb-4 rounded-full bg-gradient-to-br from-yellow-500 to-yellow-700 flex items-center justify-center shadow-lg shadow-yellow-500/30 ornament-swing" style="animation-delay: -2s;">
        ...
        >
          <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="apple-reveal">
              ...
              <div class="relative rounded-2xl lg:rounded-3xl overflow-hidden candy-cane-border p-1.5">
                ...
                <span class="absolute -top-3 -right-3 text-3xl ornament-swing" style="animation-delay: -1s;">🎄</span>
              </div>
        ...
        <!-- FEATURES: Christmas themed cards -->
        <section class="py-8 md:py-24 lg:py-32 border-t border-white/10">
          <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <!-- Section header -->
            <div class="max-w-2xl mb-6 md:mb-16 lg:mb-20 apple-reveal">
              <p class="text-sm tracking-[0.2em] uppercase text-red-400 font-semibold mb-4 flex items-center gap-2">
                <span class="twinkle">✨</span> {gettext("The Practice")} <span class="twinkle" style="animation-delay: 0.5s;">✨</span>
              </p>
              ...
              <div class="christmas-card bg-gradient-to-br from-yellow-900/50 to-yellow-950/50 backdrop-blur-sm p-6 md:p-10 lg:p-12 rounded-2xl border border-yellow-500/20 group hover:border-yellow-500/40 transition-all hover:-translate-y-1">
                <div class="relative z-10">
                  <div class="flex items-center gap-3 md:block mb-3 md:mb-0">
                    ...
                    <h3 class="text-lg md:text-xl font-semibold md:mb-3 text-white">{gettext("Topics")}</h3>
                  </div>
                  <p class="text-sm md:text-base text-white/60 leading-relaxed mb-4 md:mb-6">
        ...
        <section
          :if={@featured_topics != []}
          class="py-12 md:py-24 border-t border-white/10 bg-black/20"
        >
          <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="mb-12 md:mb-16 apple-reveal">
              <p class="text-sm tracking-[0.2em] uppercase text-green-400 font-semibold mb-4 flex items-center gap-2">
                <span>🎄</span> {gettext("Knowledge")} <span>🎄</span>
              </p>
        ...
        <!-- EVENTS SECTION -->
        <section :if={@featured_events != []} class="py-12 md:py-24 border-t border-white/10">
          <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="mb-12 md:mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6 apple-reveal">
              <div class="max-w-2xl">
                <p class="text-sm tracking-[0.2em] uppercase text-yellow-400 font-semibold mb-4 flex items-center gap-2">
                  <span>⭐</span> {gettext("Community")} <span>⭐</span>
                </p>
        ...
        <section class="py-12 md:py-32 lg:py-40 relative bg-gradient-to-br from-red-900/30 via-green-900/20 to-yellow-900/30">
          ...
          <div class="absolute top-10 right-10 text-4xl ornament-swing hidden lg:block" style="animation-delay: -1s;">🎄</div>
          <div class="absolute bottom-10 left-20 text-3xl float hidden lg:block">🎁</div>
          <div class="absolute bottom-10 right-20 text-3xl float hidden lg:block" style="animation-delay: -2s;">🎁</div>
